...
$wp_query = $wp_query = new WP_Query(); $wp_query->query('post_type=project' . '&posts_per_page=12' . '&orderby=date' . '&order=DESC' . '&paged='.$paged); //. '&cat=-10'
?>
...
<section id="generic-projects-grid" class="grid-container full appear-load-3">
  ...
  <div class="generic-grid">
    <div class="grid-x grid-padding-x medium-up-3 xlarge-up-4 align-center generic-grid-inner moose-infinite-scroll" data-equalizer="card-content" data-equalize-on="medium" data-equalize-by-row="true">
...
<?php $wp_query->the_post(); ?>
        ...
        <!--Item: -->
        <article id="post-<?php the_ID(); ?>" <?php post_class('cell item moose-infinite-scroll-item'); ?> role="article">
