  ...
  <div class="grid-x grid-padding-x align-center">
    <div class="cell medium-10 xxlarge-9">
      ...
      <div id="home-retail-outlets-grid" class="generic-grid">
          <div class="grid-x grid-padding-x small-up-2 medium-up-3 xlarge-up-4 generic-grid-inner" data-equalizer="card-content" data-equalize-by-row="true">
...
<?php $wp_query->the_post(); ?>
              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class('cell item'); ?> role="article">
                  ...
                  <ul class="cs-style-1">
                      ...
                      <li class="item-inner card text-center">
